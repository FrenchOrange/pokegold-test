...
; Unova story events
	...
	const EVENT_GOT_A_POKEMON_FROM_JUNIPER
	const EVENT_GOT_TEPIG_FROM_JUNIPER
	const EVENT_GOT_OSHAWOTT_FROM_JUNIPER
	const EVENT_GOT_SNIVY_FROM_JUNIPER
	...
	const EVENT_SPOKE_TO_LARVESTA_EGG_NPC
	const EVENT_GOT_LARVESTA_EGG
	const EVENT_SPOKE_TO_HARD_STONE_NPC
	const EVENT_GAVE_RECEPTIONIST_PLUME_FOSSIL
	const EVENT_GAVE_RECEPTIONIST_COVER_FOSSIL
	const EVENT_MET_CEDRIC
...
; Unova itemballs
	const EVENT_TEPIG_POKEBALL_IN_PLAYERS_ROOM
	const EVENT_OSHAWOTT_POKEBALL_IN_PLAYERS_ROOM
	const EVENT_SNIVY_POKEBALL_IN_PLAYERS_ROOM
	const EVENT_P2_LAB_SCOPE_LENS
	; vanilla
...
; Unova people
	const EVENT_BIANCA_CONFRONTS_HER_DAD
	const EVENT_FENNEL_IN_CONDO_1F
	const EVENT_FENNELS_CONDO_YOUNGSTER_1
	const EVENT_FENNELS_CONDO_YOUNGSTER_2
	const EVENT_ACCUMULA_POKECENTER_JUNIPER
	const EVENT_ACCUMULA_POKECENTER_BIANCA
; vanilla
	const_skip
	const_skip
