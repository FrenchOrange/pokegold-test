...
ENDM
	...
	map_attributes SilverCaveOutside, SILVER_CAVE_OUTSIDE, $0f, 0
	...
	map_attributes CinnabarIsland, CINNABAR_ISLAND, $0f, 0

	map_attributes Route20, ROUTE_20, $0f, 0

	map_attributes Route19, ROUTE_19, $0f, 0

	map_attributes FuchsiaCity, FUCHSIA_CITY, $0f, 0
	...
	map_attributes CeladonCity, CELADON_CITY, $0f, 0
	...
	map_attributes LavenderTown, LAVENDER_TOWN, $0f, 0

	map_attributes VermilionCity, VERMILION_CITY, $0f, 0

	map_attributes Route6, ROUTE_6, $0f, 0

	map_attributes SaffronCity, SAFFRON_CITY, $0f, 0
