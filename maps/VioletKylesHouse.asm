...
VioletKylesHouse_MapEvents:
	...
	def_warp_events
	warp_event  3,  7, STRIATON_CITY, 6
	...
	def_object_events
	object_event  2,  3, SPRITE_MIDDLE_M, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, VioletKylesHousePokefanMScript, -1
