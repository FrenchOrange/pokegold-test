...
VioletNicknameSpeechHouse_MapEvents:
	...
	def_warp_events
	warp_event  3,  7, STRIATON_CITY, 8
	...
	def_object_events
	object_event  2,  3, SPRITE_GIRL, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, VioletNicknameSpeechHouseTeacherScript, -1
