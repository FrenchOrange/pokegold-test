...
TrainerHouseB1F_MapEvents:
	...
	def_warp_events
	warp_event  9,  4, TRAINER_HOUSE_1F, 1
	...
	def_object_events
	object_event  7,  1, SPRITE_LINK_RECEPTIONIST, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, ObjectEvent, -1
