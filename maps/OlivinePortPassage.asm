...
OlivinePortPassage_MapEvents:
	...
	def_object_events
	object_event 17,  1, SPRITE_MIDDLE_M, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, OlivinePortPassagePokefanMScript, EVENT_OLIVINE_PORT_PASSAGE_POKEFAN_M
